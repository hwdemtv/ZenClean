...
### V0.1.8-beta (2026-05-09)
- **[集成] 全链路测试**: 完成了核心逻辑的单元测试与集成测试覆盖，确保“扫描-分析-清理”闭环的稳定性。
- **[安全] 扫描白名单**: 强化了扫描器对系统核心路径及敏感文件的过滤拦截能力。
- **[调整] 界面布局**: 暂时移除了主界面中的 OpenClaw 专清按钮，进入专项分支开发阶段。
- **[构建] 编码修复**: 修复了 Windows 环境下构建脚本的终端编码冲突问题。
